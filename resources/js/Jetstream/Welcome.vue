<template>
    <div>
        <div class="p-6 sm:px-20 bg-white dark:bg-slate-800 border-b border-gray-200">
            <div>
            ...
            <div class="mt-6 text-gray-500 dark:text-slate-50">
        ...
        <div class="bg-gray-200 dark:bg-slate-700 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
            <div class="p-6">
            ...
            <div class="p-6 border-t border-gray-200 dark:border-slate-800 md:border-t-0 md:border-l">
                <div class="flex items-center">
