<template>
    <!-- Data Table -->
    <div class="flex flex-col col-span-2 sm:col-span-4 lg:col-span-6 xl:col-span-12 xl:row-span-4 xl:p-5">
        <!-- Search Bar -->
        <div class="flex bg-slate-200 dark:bg-slate-800 rounded-full  space-x-3">
            ...
            <input class="py-2 bg-slate-200 dark:bg-slate-800 w-full focus:ring-slate-300 ring-0 focus:outline-none rounded-r-full" placeholder="Search for a Customer" v-model="this.form.search" name="search_term" id="search_term"/>
        </div>
        <!-- Table -->
